...
def load_and_process_data():
    ...
    train_data_loader = get_data_loader(train_data, batch_size=128, pad_index=pad_index, shuffle=True)
    valid_data_loader = get_data_loader(valid_data, batch_size=128, pad_index=pad_index)
    test_data_loader = get_data_loader(test_data, batch_size=128, pad_index=pad_index)
